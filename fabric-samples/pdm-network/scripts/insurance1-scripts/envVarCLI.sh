...
PEER0_ORG3_CA=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/peerOrganizations/insurance1.com/peers/peer0.insurance1.com/tls/ca.crt
...
setGlobals() {
  ...
  if [ $ORG -eq 1 ]; then
    ...
    CORE_PEER_LOCALMSPID="Insurance1MSP"
    CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_ORG3_CA
    CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/peerOrganizations/insurance1.com/users/Admin@insurance1.com/msp
    CORE_PEER_ADDRESS=peer0.insurance1.com:13051
  else
